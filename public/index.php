...
<body>
    ...
    <div class="editor">
        <form action="./create.php" method="POST">
            ...
            <div>
                <label for="craftingRequirements">
                    <span class="japanese">クラフト素材(Material,Durability,Amount)</span>
                    <span class="english">Crafting Requirements(Material,Durability,Amount)</span>
                </label>
                <div class="craftingRequirementsList">
                    <div class="craftingRequirementsListItem">
                        <input type="text" name="craftingRequirementsMaterial" id="craftingRequirementsMaterial">
                        <input type="number" name="craftingRequirementsDurability" id="craftingRequirementsDurability">
                        <input type="number" name="craftingRequirementsAmount" id="craftingRequirementsAmount">
                    </div>
                </div>
            </div>
            <div>
...
<?php if ($uploaded): ?>
    ...
    document.getElementById('id').value = nativeObject.id || '';
    document.getElementById('variant').value = nativeObject.variant || '';
    ...
    document.getElementById('damage').value = nativeObject.damage || '';
    document.getElementById('maxBullets').value = nativeObject.maxbullets || '';
    document.getElementById('price').value = nativeObject.price || '';
    document.getElementById('material').value = nativeObject.material || '';
    document.getElementById('bulletsPerShot').value = nativeObject['bullets-per-shot'] || '';
    document.getElementById('maxBulletDistance').value = nativeObject.maxBulletDistance || '';
    document.getElementById('fireRate').value = nativeObject.firerate || '';
    document.getElementById('isAutomatic').checked = nativeObject.isAutomatic || false;
    document.getElementById('recoil').value = nativeObject.recoil || '';
    ...
    document.getElementById('durability').value = nativeObject.durability || '';
    document.getElementById('maxItemStack').value = nativeObject.maxItemStack || '';
    document.getElementById('setZoomLevel').value = nativeObject.setZoomLevel || '';

    // swayオブジェクト
    if (nativeObject.sway) {
        document.getElementById('swayDefaultValue').value = nativeObject.sway.defaultValue || '';
        document.getElementById('swayDefaultMultiplier').value = nativeObject.sway.defaultMultiplier || '';
        ...
        document.getElementById('swayUnscopedModifier').value = nativeObject.sway.unscopedModifier || '';
    }

    document.getElementById('delayForReload').value = nativeObject.delayForReload || '';
    document.getElementById('delayForShoot').value = nativeObject.delayForShoot || '';
    document.getElementById('unlimitedAmmo').checked = nativeObject.unlimitedAmmo || false;
    document.getElementById('LightLevelOnShoot').value = nativeObject.LightLeveOnShoot || '';
    document.getElementById('slownessOnEquip').value = nativeObject.slownessOnEquip || '';

    // particlesオブジェクト
    if (nativeObject.particles) {
        document.getElementById('bulletParticle').value = nativeObject.particles.bullet_particle || '';
        document.getElementById('bulletParticleR').value = nativeObject.particles.bullet_particleR || '';
        document.getElementById('bulletParticleG').value = nativeObject.particles.bullet_particleG || '';
        document.getElementById('bulletParticleB').value = nativeObject.particles.bullet_particleB || '';
        document.getElementById('bulletParticleData').value = nativeObject.particles.bullet_particleData || '';
    ...
    document.getElementById('headshotMultiplier').value = nativeObject.headshotMultiplier || '';
    document.getElementById('weaponsounds_volume').value = nativeObject.weaponsounds_volume || '';
    document.getElementById('firing_knockback').value = nativeObject.firing_knockback || '';
